...
namespace ApiCatalogoJogos.Repositorio
{
    public class JogoRepositorio : IJogoRepositorio
    {
        ...
        Task<List<Jogo>> IJogoRepositorio.Obter(int pagina, int quantidade)
        {
            throw new NotImplementedException();
        }

        Task<Jogo> IJogoRepositorio.Obter(Guid id)
        {
            throw new NotImplementedException();
        }

        Task<List<Jogo>> IJogoRepositorio.Obter(string nome, string produtora)
        {
            throw new NotImplementedException();
        }

        Task<Jogo> IJogoRepositorio.Inserir(Jogo jogo)
        {
            throw new NotImplementedException();
        }
    }
